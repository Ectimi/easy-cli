...
exports.eslintCommad = exports.getEslint = void 0;
...
var eslint = new eslint_1.ESLint({
    ...
    resolvePluginsRelativeTo: (0, util_1.getDirPath)('node_modules'),
});
var getEslint = function (path) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    spinner = (0, ora_1.default)('checking...');
                    _a.label = 1;
                case 1:
                    _a.trys.push([1, 5, 6, 7]);
                    (0, util_1.loggerTiming)('ESLINT CHECK');
                    spinner.start();
                    return [4 /*yield*/, eslint.lintFiles([(0, util_1.getCwdPath)(path)])];
                case 2:
                    results = _a.sent();
                ...
                case 4:
                    ...
                    // 5. Output it.
                    if (resultText) {
                        (0, util_1.loggerError)("'PLEASE CHECK ===\u300B', ".concat(resultText));
                    }
                    else {
                ...
                case 5:
                    ...
                    return [3 /*break*/, 7];
                case 6:
                    (0, util_1.loggerTiming)('ESLINT CHECK', false);
                    return [7 /*endfinally*/];
...
exports.eslintCommad = {
    description: 'start eslint and fix code',
    command: 'eslint',
    action: exports.getEslint,
};
