...
exports.createCommad = exports.generateTemplate = void 0;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 11:
                        ...
                        (0, util_2.loggerSuccess)("Successfully created project ".concat(chalk_1.default.cyan(name)));
                        (0, util_2.loggerSuccess)("cd ".concat(chalk_1.default.cyan(name)));
                        return [3 /*break*/, 15];
                    case 12:
                        error_2 = _a.sent();
                        return [4 /*yield*/, fs_extra_1.default.emptyDir(tmpobj.name)];
                    case 13:
                        _a.sent();
                        tmpobj.removeCallback();
                    ...
                    case 14:
                        _a.sent();
                        (0, util_2.loggerError)('create failed');
                        (0, util_2.loggerError)('check error');
                        (0, util_2.loggerError)("".concat(error_2));
                        return [3 /*break*/, 15];
...
exports.createCommad = {
    ...
    action: exports.generateTemplate,
};
